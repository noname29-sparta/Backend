...
public class QCompany extends EntityPathBase<Company> {
    ...
    private static final long serialVersionUID = -260101200L;
    ...
    public final ComparablePath<java.util.UUID> managedHub = createComparable("managedHub", java.util.UUID.class);
